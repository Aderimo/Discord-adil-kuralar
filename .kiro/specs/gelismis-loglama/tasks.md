...
- [ ] 1. Veritabanı şeması güncellemesi
  - [ ] 1.1 LogPermission ve LogThreshold modellerini Prisma şemasına ekle
  ...
  - [ ] 1.2 ActivityAction tipine yeni action türlerini ekle
  ...
  - [ ] 1.3 Prisma migration çalıştır
    - _Requirements: 11.1_

- [ ] 2. Advanced Logger Service implementasyonu
  - [ ] 2.1 `src/lib/advanced-logging.ts` dosyasını oluştur
